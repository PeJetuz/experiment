...
public class LoginEventTransmitterImplTest {
    ...
    public void sendUserLoginEvent() {
        ...
        LoginEventTransmitterImpl subj = buildLogonEventTransmitter(producer);
    ...
    private LoginEventTransmitterImpl buildLogonEventTransmitter(FakeProducer producer) {
        Random random = ThreadLocalRandom.current();
        String topicName = "" + random.nextLong();
        return new LoginEventTransmitterImpl(null, producer, topicName);
    }
